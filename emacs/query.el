...
; Fonction: Present choices to the user, and ask for one of them.
; Fichiers: query.el
; Notes   : Inspired by the way `rn' presents choices.
; 
; Créé    : 30 janvier 90 ------- Martin Boyer <mboyer@ireq-robot.uucp>
; Modifié :  2 août 94 --------2- Martin Boyer <mboyer@ireq-robot.hydro.qc.ca>
;           Copyright (c) 1990, 1994 Martin Boyer and Hydro-Québec
; 
; Historique: 
; 
;  2 août 94 --------2- Martin Boyer <mboyer@ireq-robot.hydro.qc.ca>
; 	Version 1.1: Prepared for FSF distribution.
; 
...
;;; LCD Archive Entry:
;;;
;; query|Martin Boyer|mboyer@ireq-robot.hydro.qc.ca|
;; Functions to query the user|
;; 02-Aug-1994|1.1|~/packages/query.el.Z|
...
(defconst query-version "1.1"
  "The version number of the `query' library.")

(defvar confirm-level 'expand
  "*Degree of confirmation required by the confirm fonction.
