Article 3981 of gnu.emacs.sources:
Path: lerc.nasa.gov!lerc.nasa.gov!purdue!gatech!bloom-beacon.mit.edu!spool.mu.edu!uwm.edu!msunews!harbinger.cc.monash.edu.au!aggedor.rmit.EDU.AU!goanna.cs.rmit.edu.au!jacana.tusc.com.au!henryg
From: henryg@tusc.com.au (Henry Guillaume)
Newsgroups: gnu.emacs.sources
Subject: find-file.el v.4.0
Date: 22 Dec 1994 01:16:22 GMT
Organization: TUSC Computer Systems
Lines: 988
Distribution: world
Message-ID: <HENRYG.94Dec22121622@ephor.tusc.com.au>
NNTP-Posting-Host: ephor.tusc.com.au


Here is version 4.0 of find-file.el.
...
Changes between version 3.7 and 4.0 include:

 - new variable to disable #include searching (ff-ignore-include)

 - new hook (ff-file-created-hooks)

 - general cleanup of documentation & style, and improvement in performance
...
In both cases, you might want to define:

(define-key global-map "\C-co" 'ff-find-other-file)

and you might want to tune the user customisable variables to your taste.
